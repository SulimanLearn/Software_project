                    ...
                    <div class="info">
                        ...
                        <div class="categories-btns">
                            ...
                            <button
                                ...
                                :class="{ 'active-btn': activeCategory === 'upcoming' }"
                            ...
                            <button
                                class="categories-btn"
                                :class="{ 'active-btn': activeCategory === 'completed' }"
                            ...
                            <button
                                class="categories-btn"
                                :class="{ 'active-btn': activeCategory === 'cancelled' }"
                                @click="activeCategory = 'cancelled'"
                            >
                                الملغية
                            </button>
                        ...
                        <div class="cards-upcoming-dates">
                            ...
                            >
                                ...
                                <div class="btns">
                                    ...
                                    <button
                                        class="completed-btn"
                                        v-if="appointment.category === 'completed'"
                                    >
                                    ...
                                    <button
                                        class="cancelled-btn"
                                        v-if="appointment.category === 'cancelled'"
                                    >
